...
export default function GameSetup({ onStart, gameName = "Math Game" }) {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-950 to-blue-950 text-white flex flex-col items-center justify-center p-4 font-sans">
      {/* Background elements */}
      ...
      <div className="relative z-10 max-w-md w-full">
                ...
                className={`
                  ...
                  ${
                    selectedTime === option.value
                      ? "bg-gradient-to-br from-blue-500 to-cyan-500 scale-105 shadow-lg shadow-blue-500/50"
        ...
        <div className="mb-12 p-4 bg-slate-800/30 rounded-xl border border-slate-700/50">
          <p className="text-xs text-slate-400 leading-relaxed">
            <span className="font-bold text-cyan-400">📝 Rules:</span>
            <br />
            Solve as many math problems as possible before time runs out. Each
            correct answer = 10 points. Each wrong answer = -5 points.
          </p>
        </div>
